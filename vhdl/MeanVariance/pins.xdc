...
set_property PACKAGE_PIN AK34 [get_ports prog_clk_p]
...
set_property PACKAGE_PIN AJ32 [get_ports sma_clk_p]
...
set_property PACKAGE_PIN AN2 [get_ports gt_txp]
set_property PACKAGE_PIN AM8 [get_ports gt_rxp]
set_property PACKAGE_PIN AN1 [get_ports gt_txn]
